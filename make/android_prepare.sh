...
rm -rf ./$androidRoot/platforms/android/issiesign_assets/src/main/assets/videos/*
rm -rf ./$androidRoot/platforms/android/issiesign_assets3/src/main/assets/videos/*
