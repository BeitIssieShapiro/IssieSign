...
export default function InfoMyIssieSign(props) {
    return (
        <div className={"info"} scroll-marker="1" style={{
            ...
            <div className="en" >
                <bold>My IssieSign</bold> is an app for creating your own sign language video library. It was developed especially for people with complex communication needs who can benefit from the use of gestures to expand their ability to communicate.
            ...
            <div className="en" >
                ...
                <bold>My IssieSign</bold>, developed through the collaboration of The Technology Center of Beit Issie Shapiro and SAP Labs Israel, is one of a series of apps we have created with the aim of improving participation and quality of life.
